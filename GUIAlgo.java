...
class GUIAlgo {
    public static void main(String args[]) throws IOException {
        ...
        JLabel main_heading = new JLabel("BTP_DNA ENCRYPTION");
        frame.add(main_heading);
        main_heading.setBounds(170, 10, 500, 100);
        main_heading.setFont(new Font("Serif", Font.PLAIN, 35));

        File directoryPath = new File("C:\\Users\\ASHOK REDDY\\OneDrive\\Desktop\\GUI");
        ...
        JButton Encrpyt = new JButton("Encrypt");
        frame.add(Encrpyt);
        ...
        Encrpyt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    ...
                    if(rb1.isSelected()){
                        algo.mainert(FileName_Enter.getText(), key_Enter.getText(), Random_Enter.getText());
                        result.setText("check encrypted.txt");
                        result.setForeground(new Color(3, 252, 44));
                        
                    }
                    else if(rb2.isSelected()){
                        imagealgo.mainer(FileName_Enter.getText(), Random_Enter.getText(), key_Enter.getText());
